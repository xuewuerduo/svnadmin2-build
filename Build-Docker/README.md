...
然后运行：
```bash
dockerer-compose -f svnadmin2.yml up -d
```
或者使用podman-compose
```
podman-compose -f svnadmin2.yml up -d
```
## 访问界面
访问 `http://你的IP:80`
...
- 系统截图
  ![image](https://github.com/xuewuerduo/SvnAdminV2.0/blob/docker-build/00.static/demo.jpg)
...
![image](https://github.com/xuewuerduo/SvnAdminV2.0/blob/docker-build/00.static/qianyi.jpg)
